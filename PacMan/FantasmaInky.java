...
public class FantasmaInky extends Fantasma {
    ...
    public boolean comportamientoFantasma(long cronometro, int PacManXCoor, int PacManYCoor, String direccionPacMan, boolean pellet,double PacManXCoorTemp, double PacManYCoorTemp, int coorXFBlinky, int coorYFBlinky) {
